...
class Produchecklist extends StatefulWidget {
  final String ref;
  const Produchecklist({super.key, required this.ref});

  @override
  State<Produchecklist> createState() => _ProduchecklistState();
}

class _ProduchecklistState extends State<Produchecklist> {
 ...
 Future<void> send_user(lineToken, check, ref) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'เช็ครายการบัตรเข้าชม production',
